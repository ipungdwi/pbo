 ...
 */
public class DashboardAdminTracking extends HttpServlet{
    
    private final Connection conn;
    public DashboardAdminTracking() throws SQLException {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DashboardAdminTracking.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            request.getRequestDispatcher("admin/dashboardadmintracking.jsp").forward(request, response);
    }
}
