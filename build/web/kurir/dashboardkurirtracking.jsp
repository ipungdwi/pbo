<%-- 
    Document   : dashboardkurirtracking
    Created on : Oct 4, 2022, 12:14:12 AM
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a  class="nav-link" href="dashboardkurircustomers">
              <span data-feather="users" class="align-text-bottom"></span>
              Customers
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="dashboardkurirtracking">
            ...
            <tr>
              ...
              <div class="kartu">
                <form action="#" method="post">
                    ...
                    <br>
                    <a href="#popup" class="btn1">Input</a>
                </form>
              </div>
            </section>
